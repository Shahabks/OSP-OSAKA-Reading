...
if int<2
	warningfun$="音声が短い、ノイズが多いか不自然な喋り方です。もう一度試してください。"
	else
	...
	if nuofwrds<10 
				warningfun1$="発声ワード数が短いです。もう少し長く喋ってください。"
			else
		#WARNING
		...
		Erase all
		appendInfoLine: warning0$
		 appendInfoLine: warning1$
		 appendInfoLine: warning2$
		 appendInfoLine: warning3$	 
		 appendInfoLine: 'rstd:0', tab$, 'ins:0', tab$, 'qstd:0', tab$, 'lstd:0', tab$, 'nuofwrds:0', tab$, 'npause:0', tab$, 'originaldur:0', tab$, 'xx:0', tab$, xxban$
	endif	
	if nuofwrds<10
